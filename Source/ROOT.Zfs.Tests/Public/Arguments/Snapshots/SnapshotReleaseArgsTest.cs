...
{
    [TestClass]
    public class SnapshotReleaseArgsTest
    {
        ...
        {
            var args = new SnapshotReleaseArgs { Dataset = dataset, Snapshot = snapshot, Tag = tag };
        ...
        [DataRow("tank/myds","snap123","mytag",true,"release -r mytag tank/myds@snap123")] // snapshot name is only snapshot, not including dataset
        [DataRow("tank/myds", "snap123", "mytag", false, "release mytag tank/myds@snap123")]
        [DataRow("tank/myds", "tank/myds@snap123", "mytag", true, "release -r mytag tank/myds@snap123")] // Snapshot name is complete name
        [TestMethod]
