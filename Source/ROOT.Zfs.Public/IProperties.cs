...
namespace ROOT.Zfs.Public
{
    ...
    public interface IProperties : IBasicZfs
    {
        ...
        /// </summary>
        ICollection<Property> GetAvailable(PropertyTarget targetType);
        ...
        /// <returns></returns>
        PropertyValue Get(PropertyTarget targetType, string target, string property);
        ...
        /// <returns></returns>
        PropertyValue Set(PropertyTarget targetType, string target, string property, string value);
        ...
        /// <param name="target">The target - this can either be a pool, dataset, filesystem, volume or snapshot</param>
        IEnumerable<PropertyValue> GetAll(PropertyTarget targetType, string target);

        /// <summary>
        /// Resets a dataset property to its inherited value.
        /// Does not work for a zpool, since a pool cannot have a parent
        /// </summary>
        void Reset(string dataset, string property);
    }
}